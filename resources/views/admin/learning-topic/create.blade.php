...
@section('title')
    {{ __('section-title.learning_topic_add') }}
@endsection
...
<div class="row">
    ...
    <div class="col-lg-12">
        <div class="card">
            <div class="header">
                <h2><strong>{{ __('section-title.learning_topic_add') }}</strong></h2>
            </div>
            <div id="identitas" class="body">
                <form action="{{\LaravelLocalization::localizeURL('admin/topics')}}" method="POST" enctype="multipart/form-data">
                    @csrf
                    <div class="row">
